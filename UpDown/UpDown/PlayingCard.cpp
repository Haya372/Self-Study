...
namespace UpDown {
	...
	void PlayingCard::draw_Joker() {
		...
		draw_circle(-2.75, 0.7, 0.25);
		draw_circle(-2.6, 1.1, 0.25);
		draw_circle(-0.4, 1.1, 0.25);
		draw_circle(-0.25, 0.7, 0.25);
		draw_circle(-2.75, -0.6, 0.25);
		draw_circle(-2.6, -1, 0.25);
		draw_circle(-0.4, -1, 0.25);
		draw_circle(-0.25, -0.6, 0.25);
		glBegin(GL_QUADS);
		glVertex2f(-2.75, 0.7);
		glVertex2f(-2.6, 1.1);
		glVertex2f(-0.25, -0.6);
		...
		for (float i = 0; i < 2 * M_PI; i += 0.01) {
			glVertex2f(x + 0.75*cos(i), y + 0.6*sin(i));
		}
		glEnd();
		x = -1.5; y = 1.5;
		glBegin(GL_POLYGON);
		for (float i = 0; i < 2 * M_PI; i += 0.01) {
			glVertex2f(x + 0.55*cos(i), y + 0.8*sin(i));
		}
		glEnd();
		//目
		...
		glBegin(GL_POLYGON);
		for (float i = 0; i < 2 * M_PI; i += 0.01) {
			glVertex2f(x + 0.18*cos(i), y + 0.25*sin(i));
		}
		glEnd();
		x = -1.2; y = 1.7;
		glBegin(GL_POLYGON);
